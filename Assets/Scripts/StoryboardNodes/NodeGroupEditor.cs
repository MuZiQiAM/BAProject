...
namespace XNodeEditor.NodeGroups {
	...
	public class NodeGroupEditor : NodeEditor {
		...
		public static Texture2D corner { get { return _corner != null ? _corner : _corner = Resources.Load<Texture2D>("xnode_dot_outer"); } }
		...
		private void DrawGroupTypeSelector() {
			EditorGUI.BeginChangeCheck();
			GroupType newType = (GroupType)EditorGUILayout.EnumPopup("Group Type", group.groupType);
			if (EditorGUI.EndChangeCheck()) {
				Undo.RecordObject(group, "Change Group Type");
		...
		public override Color GetTint() => group.GetGroupColor();
